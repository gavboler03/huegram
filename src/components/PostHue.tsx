    ...
    <div className="flex flex-row p-4 justify-evenly gap-8">
      ...
      >
        ...
        <a
          ...
          className="btn bg-white text-black text-center mt-24 text-xl font-bold rounded-3xl hover:-translate-y-0.5 hover:bg-blue-300 transition duration-200 shadow-black shadow-sm p-1"
        >
          Post
        </a>
      </div>
